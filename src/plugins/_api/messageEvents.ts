    ...
    patches: [
        {
            ...
            replacement: {
                ...
                replace: (match, args) => "" +
                    `async ${match}` +
                    `if(await Swancord.Api.MessageEvents._handlePreEdit(${args}))` +
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: (m, parsedMessage, channel, replyOptions, extra) => m +
                    `if(await Swancord.Api.MessageEvents._handlePreSend(${channel}.id,${parsedMessage},${extra},${replyOptions}))` +
        ...
        },
        {
            ...
            replacement: {
                ...
                replace: (m, message, channel, event) =>
                    `const vcMsg=${message},vcChan=${channel};${m}Swancord.Api.MessageEvents._handleClick(vcMsg,vcChan,${event});`
            }
        }
    ]
});
