...
const CONTRIBUTOR_BADGE = "swancord:///assets/SwancordIcon.png";
...
async function loadBadges(noCache = false) {
    ...
    DonorBadges = await fetch("https://badges.swancord.dev/badges.json", init)
        .then(r => r.json())
        .catch(() => ({}));
}
            ...
            onClick() {
                const modalKey = openModal(props => (
                    <ErrorBoundary noop onError={() => {
                        closeModal(modalKey);
                        SwancordNative.native.openExternal("https://github.com/sponsors/Vendicated");
                    }}>
                        <ModalRoot {...props}>
                            <ModalHeader>
                                <Forms.FormTitle
                            ...
                            <ModalContent>
                                ...
                                <div style={{ padding: "1em" }}>
                                    <Forms.FormText>
                                        This Badge is a special perk for Swancord Donors
                                    </Forms.FormText>
                                    <Forms.FormText className={Margins.top20}>
                                        Please consider supporting the development of Swancord by becoming a donor. It would mean a lot!!
                                    </Forms.FormText>
                                </div>
                            </ModalContent>
                            <ModalFooter>
