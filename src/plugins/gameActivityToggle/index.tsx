...
import SwancordToolboxPlugin from "@plugins/swancordToolbox";
...
const settings = definePluginSettings({
    ...
    location: {
        ...
        options: [
            ...
            { label: "Swancord Toolbox", value: "TOOLBOX" }
        ],
        get hidden() {
            return !isPluginEnabled(SwancordToolboxPlugin.name);
        }
    }
});
...
function GameActivityToggleButton(props: { nameplate?: any; }) {
    ...
    if (location !== "PANEL" && isPluginEnabled(SwancordToolboxPlugin.name)) return null;
