...
function SwancordPopoverButtons(props: { Component: React.ComponentType<MessagePopoverButtonItem>, message: Message; }) {
...
export function _buildPopoverElements(
    ...
    return <SwancordPopoverButtons Component={Component} message={message} />;
}
