...
import { FluxEvents } from "@swancord/discord-types";
...
export function addPatch(newPatch: Omit<Patch, "plugin">, pluginName: string, pluginPath = `Swancord.Plugins.plugins[${JSON.stringify(pluginName)}]`) {
