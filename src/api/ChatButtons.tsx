...
function SwancordChatBarButtons(props: ChatBarProps) {
...
export function _injectButtons(buttons: ReactNode[], props: ChatBarProps) {
    ...
    buttons.unshift(<SwancordChatBarButtons key="swancord-chat-buttons" {...props} />);
}
...
addContextMenuPatch("textarea-context", (children, args) => {
    ...
    group.splice(idx, 0,
        <Menu.MenuItem id="vc-chat-buttons" key="swancord-chat-buttons" label="Swancord Buttons">
            {buttons.map(([id]) => (
