...
export default {
    ...
    disboard: {
        /** Fetch a Disboard URL from the main process (bypasses CORS). Returns raw HTML/text or null on error. */
        fetch: (path: string) => invoke<string | null>(IpcEvents.DISBOARD_FETCH, path),
    },
