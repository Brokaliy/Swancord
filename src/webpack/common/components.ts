...
import * as t from "@swancord/discord-types";
...
export const Forms = {
    ...
    /** @deprecated use Heading from Swancord */
    FormTitle: Heading,
    /** @deprecated use Paragraph from Swancord */
    FormText: Paragraph,
...
/** @deprecated use Paragraph, Span, or BaseText from Swancord */
export const Text = TextCompat;
/** @deprecated use Button from Swancord */
export const Button = ButtonCompat;
/** @deprecated Use FormSwitch from Swancord */
...
/** @deprecated import from @swancord/components */
