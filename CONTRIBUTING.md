# Contributing to Swancord

Swancord is a community project and welcomes any kind of contribution from anyone!

We have development documentation for new contributors, which can be found at <https://docs.swancord.dev>.
...
- Check our [plugin requests tracker](https://github.com/Swancord/plugin-requests/issues) to see if there is an existing request, or if the same idea has been rejected
- If there isn't an existing request, [open one](https://github.com/Swancord/plugin-requests/issues/new?assignees=&labels=&projects=&template=request.yml) yourself
...
## Improve Swancord itself

If you have any ideas on how to improve Swancord itself, or want to propose a new plugin API, feel free to open a feature request so we can discuss.

Or if you notice any bugs or typos, feel free to fix them!

## Contribute to our Documentation

The source code of our documentation is available at <https://github.com/Swancord/Docs>
...
We have an open support channel in our [Discord community](https://swancord.dev/discord).
